...
- core/AlpineStore.js: Store factory for reactive frontend state.
...
```
- Store Registration: Use createStore from /mod/_core/framework/AlpineStore.js.
- Modals: Use the modal helpers exposed by /mod/_core/framework/modals.js.
